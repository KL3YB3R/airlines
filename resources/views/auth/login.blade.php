...
@section('content')
    <main class="bg-gray-800 flex justify-center items-center h-screen">
        <form method="POST" class="bg-white p-5 w-1/4 rounded">
            <h1 class="border-b-2 border-gray-800 text-2xl pb-2 pl-2 mb-4">Login</h1>
            <aside class="flex flex-col mb-10">
                <label for="username" class="pl-2 mb-1 text-md">Username or Email</label>
                <input type="text" id="username" class="border border-gray-500 p-2 rounded-xl text-lg outline-none" placeholder="Type username or Email">
                <label for="password" class="pl-2 mt-6 mb-1 text-md">Password</label>
                <input type="password" id="password" class="border border-gray-500 p-2 rounded-xl text-lg outline-none" placeholder="Type username or Email">
            </aside>
